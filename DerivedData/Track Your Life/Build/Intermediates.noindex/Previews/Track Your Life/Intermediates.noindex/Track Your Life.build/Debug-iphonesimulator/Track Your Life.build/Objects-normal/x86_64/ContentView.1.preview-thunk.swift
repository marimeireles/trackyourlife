        ...
        VStack {
            HStack {
                Button(action: {
                    ...
                    Image(systemName: __designTimeString("#4841.[5].[8].property.[0].[0].arg[0].value.[0].arg[0].value.[0].arg[1].value.[0].arg[0].value", fallback: "arrow.left"))
                }
                ...
                Button(action: {
                    ...
                    Image(systemName: __designTimeString("#4841.[5].[8].property.[0].[0].arg[0].value.[0].arg[0].value.[2].arg[1].value.[0].arg[0].value", fallback: "arrow.right"))
                }
            }
            .padding()
            
            HStack {
                TextField(__designTimeString("#4841.[5].[8].property.[0].[0].arg[0].value.[1].arg[0].value.[0].arg[0].value", fallback: "Habit name"), text: $habitName)
                    .textFieldStyle(RoundedBorderTextFieldStyle())
                Button(__designTimeString("#4841.[5].[8].property.[0].[0].arg[0].value.[1].arg[0].value.[1].arg[0].value", fallback: "Add Habit")) {
            ...
            List {
                ForEach(habitViewModel.habitsForDate(habitViewModel.currentDate)) { habit in
                    HStack {
                        Text(habit.name)
                            .onTapGesture {
                                print(__designTimeString("#4841.[5].[8].property.[0].[0].arg[0].value.[2].arg[0].value.[0].arg[1].value.[0].arg[0].value.[0].modifier[0].arg[0].value.[0].arg[0].value", fallback: "☀️☀️☀️"))
                                self.selectedHabitId = habit.id
                                self.editedHabitName = habit.name
                                self.showEditAlert = true
                            }
                        Spacer()
                        Image(systemName: habit.isComplete ? __designTimeString("#4841.[5].[8].property.[0].[0].arg[0].value.[2].arg[0].value.[0].arg[1].value.[0].arg[0].value.[2].arg[0].value.then", fallback: "checkmark.circle.fill") : __designTimeString("#4841.[5].[8].property.[0].[0].arg[0].value.[2].arg[0].value.[0].arg[1].value.[0].arg[0].value.[2].arg[0].value.else", fallback: "circle"))
                            .resizable()
...
extension EditHabitAlert {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        #sourceLocation(file: "/Users/mariana/dev/Track Your Life/Track Your Life/ContentView.swift", line: 91)
        VStack {
            Text(__designTimeString("#4841.[4].[3].property.[0].[0].arg[0].value.[0].arg[0].value", fallback: "Edit Habit"))
                .font(.headline)
            TextField(__designTimeString("#4841.[4].[3].property.[0].[0].arg[0].value.[1].arg[0].value", fallback: "Habit name"), text: $habitName)
                .textFieldStyle(RoundedBorderTextFieldStyle())
                .padding()
            HStack {
                Button(__designTimeString("#4841.[4].[3].property.[0].[0].arg[0].value.[2].arg[0].value.[0].arg[0].value", fallback: "Save")) {
                    onSave()
                    isPresented = false
                }
                Button(__designTimeString("#4841.[4].[3].property.[0].[0].arg[0].value.[2].arg[0].value.[1].arg[0].value", fallback: "Cancel")) {
                    isPresented = false
                }
            }
        }
...
extension HabitViewModel {
    @_dynamicReplacement(for: habitsForDate(_:)) private func __preview__habitsForDate(_ date: Date) -> [Habit] {
        #sourceLocation(file: "/Users/mariana/dev/Track Your Life/Track Your Life/ContentView.swift", line: 78)
...
extension HabitViewModel {
    @_dynamicReplacement(for: saveData()) private func __preview__saveData() {
        #sourceLocation(file: "/Users/mariana/dev/Track Your Life/Track Your Life/ContentView.swift", line: 65)
...
extension HabitViewModel {
    @_dynamicReplacement(for: addHabit(name:)) private func __preview__addHabit(name: String) {
        ...
        print(__designTimeString("#4841.[3].[4].[2].arg[0].value", fallback: "☀️☀️☀️"))
        saveData()
